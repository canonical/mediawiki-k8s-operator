...
.. list-table::
   ...
   * - `$wgArticlePath <https://www.mediawiki.org/wiki/Manual:$wgArticlePath>`__
     - .. centered:: :bdg-success:`Yes`
     - 
   * - `$wgAuthenticationTokenVersion <https://www.mediawiki.org/wiki/Manual:$wgAuthenticationTokenVersion>`__
     - .. centered:: :bdg-danger:`No`
     - Generated by the charm. It can be rotated with ``rotate-mediawiki-secrets``.
