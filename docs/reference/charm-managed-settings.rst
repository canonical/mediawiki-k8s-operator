...
.. list-table::
   ...
   * - `$wgEnableEmail <https://www.mediawiki.org/wiki/Manual:$wgEnableEmail>`__
     - .. centered:: :bdg-warning:`Partially`
     - This is set to ``false`` when the :ref:`smtp relation <reference_relation_endpoints_smtp>` data is incomplete or malformed.
   ...
   * - `$wgPluggableAuth_Config['OpenIDConnect'] <https://www.mediawiki.org/wiki/Extension:PluggableAuth>`__
     - .. centered:: :bdg-warning:`Partially`
     - This is only set when the :ref:`oauth relation <reference_relation_endpoints_oauth>` is in use. The charm configures ``plugin``, ``data.providerURL``, ``data.clientID``, ``data.clientSecret``, ``data.scope``, and ``data.proxy``. User modifications are otherwise merged in where possible.
   * - `$wgPluggableAuth_Config['SimpleSAMLphp'] <https://www.mediawiki.org/wiki/Extension:PluggableAuth>`__
     - .. centered:: :bdg-warning:`Partially`
   ...
   * - `$wgSessionSecret <https://www.mediawiki.org/wiki/Manual:$wgSessionSecret>`__
     - .. centered:: :bdg-danger:`No`
     - This is generated by the charm. Refer to the :ref:`security overview <explanation_security>` for more information.
   * - `$wgSMTP <https://www.mediawiki.org/wiki/Manual:$wgSMTP>`__
     - .. centered:: :bdg-warning:`Partially`
     - This is only set when the :ref:`smtp relation <reference_relation_endpoints_smtp>` is in use.
   * - `$wgSimpleSAMLphp_InstallDir <https://www.mediawiki.org/wiki/Extension:SimpleSAMLphp>`__
     - .. centered:: :bdg-danger:`No`
     - 
