...
.. seealso::
   ...
   Please refer to this `composer.json file <https://github.com/canonical/mediawiki-k8s-operator/blob/main/mediawiki_rock/files/mediawiki/composer.local.json>`_ for specifics on the extensions and skins that the MediaWiki charm installs in addition to what MediaWiki bundles.
