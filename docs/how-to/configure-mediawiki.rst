...
.. note::
   ...
   The ``LocalSettings.php`` file provided using the charm configuration is stored outside of the webroot and is not world-readable. This is to minimize the risk of exposing sensitive information. Refer to the :ref:`security overview <explanation_security>` for more details.
