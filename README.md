...
| [S3 backend adapter](src/templates/S3Backend.php.template) | [GNU General Public License, version 2.0 or later](https://www.gnu.org/licenses/old-licenses/gpl-2.0.html) | Derived from [Extension:AWS](https://github.com/edwardspec/mediawiki-aws-s3)                     |
